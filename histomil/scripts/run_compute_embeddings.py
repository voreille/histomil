...
def compute_embeddings(cfg: DictConfig) -> None:
    for model_name in cfg.models:
        ...
        output_path = (
            ...
            / f"{model_name}_cptac_{cfg.compute.magnification}x.h5"
        )
        output_path.parent.mkdir(parents=True, exist_ok=True)

        try:
            # Import your embedding computation function
            from histomil.data.compute_embeddings import compute_and_store_embeddings
            ...
            compute_and_store_embeddings(
                ...
                magnification=cfg.compute.magnification,
            )
